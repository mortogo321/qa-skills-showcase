import { errors, users } from '../../src/data/users';
...
test.describe('Login', () => {
	...
	test('valid login lands on the inventory page @smoke', async ({
		page,
		loginPage,
	}) => {
	...
	test('locked_out_user shows the locked-out error @smoke', async ({
		loginPage,
	}) => {
